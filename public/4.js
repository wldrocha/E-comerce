...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  }, _defineProperty(_mutations, "SET_TOKEN", function SET_TOKEN(state, token) {
    state.token = token;
  ...
  getters: {
    ...
    getHeader: function getHeader(state, getters) {
    ...
    isAuthUser: function isAuthUser(state) {
      if (state.user._id) {
        return state.user;
      } else {
        return null;
    ...
    isAuthToken: function isAuthToken(state) {
